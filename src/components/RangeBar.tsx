		...
		<>
			<div class="mt-5 relative h-10">
				...
				<div
					...
					style={`left: ${leftPct}%;`}
				/>
				<div class="absolute left-0 top-full mt-1 text-[10px] tab-num text-amber-300/80">
					{fmtMoney(min)}
				</div>
				...
				<div class="absolute right-0 top-full mt-1 text-[10px] tab-num text-rose-300/80">
					{fmtMoney(max)}
				</div>
			</div>
