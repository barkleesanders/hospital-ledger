...
export function homePage(url: string) {
	return (
		<Layout
		...
		>
			<header class="border-b border-zinc-800 bg-gradient-to-b from-zinc-900 to-zinc-950">
				<div class="mx-auto max-w-6xl px-4 sm:px-6 pt-8 pb-10 sm:pt-10 sm:pb-12 md:pt-14 md:pb-16">
					...
					<h1 class="mt-5 serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.05] tracking-tight max-w-4xl">
						What does your hospital <em class="text-emerald-300">actually</em>{" "}
						charge?
					</h1>
					<p class="mt-5 text-base sm:text-lg md:text-xl text-zinc-300 max-w-2xl leading-snug">
						Compare standardized price rows from{" "}
						<span
							id="hero-hospital-count"
							class="font-semibold text-white tab-num"
						>
							{fmt(standardizedPriceHospitals)}
						</span>{" "}
						U.S. hospitals — straight from each hospital's own
						federally-mandated price file. We separately verified{" "}
						<span
							id="hero-live-mrf-count"
							class="font-semibold text-white tab-num"
						>
							{fmt(liveMrfRequired)}
						</span>{" "}
					...
					<p class="mt-5 text-sm sm:text-base text-zinc-400 max-w-2xl leading-relaxed">
						...
						<code class="mono text-zinc-200">n &gt; 0</code> price rows. Every
						number is mirrored in{" "}
						<a
					...
					<div class="mt-5 text-sm sm:text-base text-zinc-400 max-w-2xl leading-relaxed">
						...
						<p class="mt-1.5">
							<span class="tab-num text-zinc-200">{fmt(liveMrfRequired)}</span>{" "}
							hospitals have a live price file, but{" "}
							<span class="tab-num text-zinc-200">
								{fmt(liveMrfRequired - standardizedPriceHospitals)}
							</span>{" "}
							of them aren't in the{" "}
							<span class="tab-num text-zinc-200">
								{fmt(standardizedPriceHospitals)}
							</span>{" "}
							headline — for two reasons:
						</p>
						<ul class="mt-2.5 space-y-2.5 list-disc pl-6 marker:text-emerald-400">
							<li>
								<span class="tab-num font-semibold text-zinc-100">
									{fmt(parsedMrfOutputs - standardizedPriceHospitals)}
								</span>{" "}
								published a file that is empty or a placeholder — zero usable
								price rows. That is a gap in the hospital's own compliance, not
								a parsing failure on our side.
							</li>
							<li>
								<span class="tab-num font-semibold text-zinc-100">
									{fmt(liveMrfRequired - parsedMrfOutputs)}
								</span>{" "}
								publish a file we cannot retrieve — blocked by the hospital's
								CDN, password-protected, or locked behind a vendor download
								portal.
							</li>
						</ul>
						<p class="mt-2.5">
							Every CMS-required hospital with a live file is now accounted for.
							Full breakdown at{" "}
							<a
								href="/about-the-numbers"
								class="underline hover:text-emerald-300"
							>
								/about-the-numbers
							</a>
					...
					<p class="mt-6 max-w-2xl border-t border-zinc-800 pt-4 text-sm text-zinc-400 leading-relaxed">
						<span class="font-semibold text-zinc-200">Disclaimer:</span> prices
						are reproduced as published in each hospital's machine-readable file
						and may be incomplete, outdated, or inconsistent. They are not a
						quote and not a guarantee of cost — what you actually pay depends on
						your insurance, the specific services, and negotiated rates. Always
						confirm directly with the hospital and your insurer before relying
						on any figure here. Hospital Ledger is an independent
						public-interest project, not affiliated with CMS, HHS, or any
						hospital.
					</p>
					...
					<div class="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3 text-xs text-zinc-400">
						<div class="flex items-start gap-2">
							<svg
								class="w-4 h-4 mt-0.5 text-emerald-400 shrink-0"
								fill="none"
								stroke="currentColor"
								stroke-width="2"
								viewBox="0 0 24 24"
					...
					<div class="mt-8 grid grid-cols-2 md:grid-cols-4 gap-3">
						<div class="rounded-lg bg-zinc-900 border border-zinc-800 p-4">
							...
							<div
								id="kpi-patient-hospitals"
								class="mt-1 text-3xl font-semibold tab-num text-emerald-300"
							>
								{fmt(standardizedPriceHospitals)}
							</div>
						...
						<div class="rounded-lg bg-zinc-900 border border-zinc-800 p-4">
							...
							<div class="mt-1 text-3xl font-semibold tab-num text-emerald-300">
								$0
							</div>
							<div class="text-xs text-zinc-500 mt-1">
					...
					<div class="mt-8 flex flex-wrap gap-3 text-sm">
						<a
							href="#for-patients"
							class="rounded-md bg-emerald-500 px-5 py-2.5 font-medium text-zinc-950 hover:bg-emerald-400 transition"
						>
							Find a price →
						</a>
						<a
							href="#how-it-works"
							class="rounded-md border border-zinc-700 px-5 py-2.5 text-zinc-200 hover:bg-zinc-800 transition"
						>
							How it works
						</a>
						<a
			...
			<main class="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-10 space-y-10 sm:space-y-12">
				...
				>
					...
					<h2 class="serif text-2xl sm:text-3xl md:text-4xl mb-2">
						Three ways to start.
					</h2>
					<p class="text-zinc-400 mb-5 max-w-2xl">
						Search by what you need, your insurance, or the hospital you're
						going to. Every price is straight from that hospital's own published
						file.
					</p>
					<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
						<form
							id="by-proc-form"
							class="rounded-lg border border-zinc-800 bg-zinc-950/60 p-4 lift min-w-0"
							autocomplete="off"
						>
							...
							<label
								for="by-proc-input"
								class="block serif text-xl mb-1 text-zinc-100"
							>
								A procedure or test
							</label>
							...
							<div class="flex gap-2 min-w-0">
								...
								<button
									type="submit"
									class="shrink-0 rounded-md bg-emerald-600 hover:bg-emerald-500 px-3 py-2 text-sm font-medium"
								>
									Compare
								</button>
							</div>
							...
							<div
								id="by-proc-msg"
								class="mt-2 text-xs text-zinc-500 min-h-4"
							/>
						</form>
						<form
							id="by-payer-form"
					...
					<p class="mt-4 text-xs text-zinc-500">
						Every price comes straight from the hospital's federally-mandated
						machine-readable file. The "cash price" is the self-pay discount
						they're required to publish. Your actual bill depends on your plan,
				...
				<section id="how-it-works">
					...
					<h2 class="serif text-2xl sm:text-3xl md:text-4xl mb-6">
					...
					<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
						<div>
							...
							<p class="text-zinc-400">
								Type a procedure name (<em>"MRI knee"</em>), a CPT code (
								<code class="mono text-emerald-300">73721</code>), an insurer,
								or a hospital. We match it against every U.S. hospital's
						...
						<div>
							...
							<p class="text-zinc-400">
								See the gross price, the cash discount, and the rate every
								insurance plan negotiated — side by side across hundreds of
								hospitals.
							</p>
						</div>
						<div>
							...
							<p class="text-zinc-400">
								Pick the hospital that costs less for the procedure you need.
								Bring the price to your appointment if there's a dispute.{" "}
								<span class="text-zinc-500">
									(Always confirm directly — we publish what they published.)
								</span>
							</p>
						</div>
					</div>
						...
						<ul class="space-y-3 text-zinc-300 leading-relaxed">
							<li class="flex gap-3">
								...
								<span>
									...
									, every U.S. hospital must publish a machine-readable price
									file — gross charges, cash prices, negotiated rates, and
									min/max — free, public, no signup.
								</span>
							</li>
							<li class="flex gap-3">
								<span class="text-emerald-400 mt-1">▸</span>
								<span>
									Most hospitals technically comply by uploading a giant
									unreadable file. We verified live MRFs for{" "}
									<span class="tab-num">{fmt(liveMrfRequired)}</span> of{" "}
									<span class="tab-num">{fmt(cmsRequiredTotal)}</span>{" "}
									CMS-required hospitals and standardized price rows for{" "}
									<span class="tab-num">{fmt(standardizedPriceHospitals)}</span>{" "}
									of them.
								</span>
							</li>
							<li class="flex gap-3">
								...
								<span>
									...
									-hospital gap between "live MRF" and "standardized prices" is
									the parser's coverage hole — files we can download but haven't
									fully extracted usable rows from yet (
									{fmt(parsedMrfOutputs - standardizedPriceHospitals)} parsed to
									zero rows, {fmt(liveMrfRequired - parsedMrfOutputs)} still in
									the parse queue). Closing it is in progress; see{" "}
									<a
										href="/about-the-numbers"
										class="text-emerald-300 underline"
									>
							...
							<li class="flex gap-3">
								...
								<span>
									...
									for the same reason — pricing transparency in healthcare.
									We're doing it for hospitals.
								</span>
							</li>
						</ul>
					</div>
					<aside class="rounded-lg border border-zinc-800 bg-zinc-900 p-5">
						...
						<div class="mt-2 text-zinc-100">
							...
							<span class="text-zinc-400 text-sm">
								42 USC § 300gg-18 · 45 CFR § 180.90
							</span>
						</div>
						<hr class="my-4 border-zinc-800" />
						<div class="text-xs uppercase text-zinc-500 tracking-wider">
							CMS escalation ladder
						</div>
				...
				>
					...
					<p class="text-zinc-300 max-w-3xl leading-relaxed">
						...
						code" differently; the CMS rule mandates the data points, not the
						column names. So every file is a new schema-mapping problem.
					</p>
					...
					<div class="mt-5 rounded-lg border border-zinc-800 bg-zinc-950/60 p-4 sm:p-5">
						...
						<div class="overflow-x-auto">
							<table class="w-full text-sm tab-num">
								...
								<tbody class="text-zinc-300 divide-y divide-zinc-800/60">
									<tr>
										<td class="py-2 pr-3">
											Parse each MRF (download · open · map columns · normalize
											· QA)
										</td>
										<td class="py-2 pr-3">
											{fmt(parsedMrfOutputs)} parsed outputs;{" "}
											{fmt(standardizedPriceHospitals)} with rows
										</td>
										<td class="py-2 pr-3">
											~77 min avg (90% × 66 min clean + 10% × 180 min hard)
										</td>
										<td class="py-2 pr-3 text-right text-emerald-300">4,747</td>
									</tr>
									<tr>
										<td class="py-2 pr-3">
											Find candidate MRF URLs from CMS + transparency pages
										</td>
									...
									<tr>
										<td class="py-2 pr-3">
											Probe URLs for liveness (curl / browser open)
										</td>
									...
									<tr>
										<td class="py-2 pr-3">
											Rediscover dead links by hunting each hospital's site
										</td>
									...
									<tr>
										<td class="py-2 pr-3">
											Validate CPT / HCPCS codes against AMA reference
										</td>
										<td class="py-2 pr-3">5,000 codes</td>
										<td class="py-2 pr-3">
											~3 codes / min spot-check + cleanup
										</td>
										<td class="py-2 pr-3 text-right text-emerald-300">30</td>
									</tr>
									<tr>
										<td class="py-2 pr-3">
											Ingest + link CMS enforcement actions to CCNs
										</td>
									...
									<tr>
										<td class="py-2 pr-3">
											Build the cross-hospital price index (joins, dedup,
											pivots)
										</td>
										<td class="py-2 pr-3">
											{fmt(cptIndexedRows)} CPT / HCPCS rows
										</td>
										<td class="py-2 pr-3">
											Excel/Power Query at solo-analyst pace
										</td>
										<td class="py-2 pr-3 text-right text-emerald-300">40</td>
									</tr>
									<tr>
										<td class="py-2 pr-3">
											Design + build the SSR site, API, search, charts
										</td>
									...
									<tr class="bg-emerald-950/20 font-semibold">
										...
										<td class="py-2 pr-3 text-zinc-400">
											≈ 2,080 hr / person-year (full-time)
										</td>
										<td class="py-2 pr-3 text-right text-emerald-300">
											~5,930
										</td>
									</tr>
								</tbody>
						...
						<p class="mt-3 text-xs text-zinc-500">
							...
							per-MRF column-mapping pass and the payer-name canonicalization
							row.
						</p>
					</div>
					...
					<div class="mt-5 rounded-lg border border-zinc-800 bg-zinc-950/60 p-4 sm:p-5">
						...
						<div class="grid sm:grid-cols-3 gap-3">
							<div class="rounded-lg border border-zinc-800 bg-zinc-900/60 p-4">
								...
								<div class="text-xs text-zinc-500 mt-2 leading-relaxed">
									5,930 hr × $100/hr — the midpoint of published US healthcare
									data-analyst freelance rates ($93–$160/hr per{" "}
									<a
									...
									). Senior healthcare specialists quote ~$200/hr — that's a
									$1.18M build.
								</div>
							</div>
							<div class="rounded-lg border border-zinc-800 bg-zinc-900/60 p-4">
								...
								<div class="text-xs text-zinc-500 mt-2 leading-relaxed">
									...
									, PayerPrice, Trilliant) hides pricing behind a sales call.
									None publishes a number on its public site. The absence is the
									answer.
								</div>
							</div>
							<div class="rounded-lg border border-emerald-700/50 bg-emerald-950/30 p-4">
								<div class="text-xs uppercase tracking-wider text-emerald-300">
									What we charge
								</div>
								<div class="mt-2 text-3xl font-semibold tab-num text-emerald-300">
									$0
								</div>
								<div class="text-xs text-zinc-400 mt-2 leading-relaxed">
									Free forever. CC0 public-domain data. AGPLv3 code. No signup,
									no API key, no rate-limited tier. The full dataset and the
									full source — including the search, the API, and the
									cross-hospital price index — are <em>and will stay</em> free.
								</div>
							</div>
						</div>
						<p class="mt-4 text-xs text-zinc-500 max-w-3xl">
							...
							. Aggregating it into one queryable place doesn't make it ours to
							sell — it just makes it actually usable.
						</p>
					</div>
					...
					<div class="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
						<div class="rounded-lg bg-zinc-950/50 border border-zinc-800 p-4">
							...
							<div class="mt-1 text-2xl font-semibold tab-num text-emerald-300">
								99 GB
							</div>
							<div class="text-xs text-zinc-500 mt-1">
						...
						<div class="rounded-lg bg-zinc-950/50 border border-zinc-800 p-4">
							...
							<div class="mt-1 text-2xl font-semibold tab-num text-emerald-300">
								{fmt(parsedMrfOutputs)}
							</div>
							<div class="text-xs text-zinc-500 mt-1">
								{fmt(standardizedPriceHospitals)} produced standardized rows
							</div>
						</div>
						<div class="rounded-lg bg-zinc-950/50 border border-zinc-800 p-4">
							<div class="text-xs uppercase tracking-wider text-zinc-500">
					...
					<div class="mt-6 grid md:grid-cols-2 gap-4">
						<div class="rounded-lg border border-zinc-800 bg-zinc-950/50 p-4">
							...
							<ol class="space-y-1.5 text-sm text-zinc-300 list-decimal pl-4">
								<li>
									Seed the CMS hospital universe ({fmt(totalFacilities)}{" "}
									facilities)
								</li>
						...
						<div class="rounded-lg border border-zinc-800 bg-zinc-950/50 p-4">
							...
							<ul class="space-y-2 text-sm text-zinc-300">
								<li class="flex gap-2">
									...
									<span>
										Commercial aggregators (Turquoise, PayerPrice, Serif) lock
										the data behind NDAs.
									</span>
								</li>
								<li class="flex gap-2">
									<span class="text-emerald-400 mt-0.5">▸</span>
									<span>
										CMS publishes the rule but doesn't aggregate or verify
										anything.
									</span>
								</li>
								<li class="flex gap-2">
									<span class="text-emerald-400 mt-0.5">▸</span>
									<span>
										Every hospital uses a different format, vendor, and URL
										convention.
									</span>
								</li>
								<li class="flex gap-2">
									<span class="text-emerald-400 mt-0.5">▸</span>
									<span>
										13.8% of files sit behind bot defenses; "compliance" ≠
										"reachable".
									</span>
								</li>
								<li class="flex gap-2">
									<span class="text-emerald-400 mt-0.5">▸</span>
									<span>
										Until LLM agents got good at parsing arbitrary CSV / JSON
										shapes, this scale of normalization wasn't cost-effective
										for one person.
									</span>
								</li>
							</ul>
					...
					<p class="mt-6 text-sm text-zinc-400 max-w-3xl">
						...
						— 34 pipeline scripts, ~10,700 lines of Python, ~3,400 lines of
						TypeScript. AGPLv3 code, CC0 data.{" "}
						<span class="text-zinc-500">
							No tracking. No signup. Free forever.
						</span>
					</p>
				</section>
				...
				<section id="search">
					...
					<p class="text-sm text-zinc-400 mt-1">
						Real-time filter across all{" "}
						<span id="hosp-count">{fmt(totalFacilities)}</span> facilities.{" "}
						<span class="text-zinc-500">
							{fmt(cmsRequiredTotal)} are CMS-required;{" "}
							{fmt(standardizedPriceHospitals)} currently have standardized
							price rows.
						</span>
					</p>
					<div class="mt-4 grid md:grid-cols-[1fr_180px_160px] gap-3">
						...
						<select
							id="state"
							class="rounded-md bg-zinc-900 border border-zinc-700 text-zinc-100 px-3 py-3"
						/>
						<select
							id="status"
							class="rounded-md bg-zinc-900 border border-zinc-700 text-zinc-100 px-3 py-3"
				...
				<section id="worst">
					...
					<p class="text-sm text-zinc-400 mt-1">
						CMS-required hospitals with the most enforcement actions{" "}
						<em>and</em> no findable MRF.
					</p>
				...
				<section
					id="methodology"
					class="rounded-lg border border-zinc-800 bg-zinc-900/60 p-4 sm:p-6"
				>
					<div class="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
						<div>
							...
							<p class="text-sm text-zinc-400 mt-1">
								The inputs, checks, and limits are listed here on the site, not
								just in the repo.
							</p>
						</div>
						<a
					...
					<div class="mt-6 grid gap-4 md:grid-cols-3">
						<div class="rounded-lg border border-zinc-800 bg-zinc-950/50 p-4">
							...
							<ul class="mt-3 space-y-2 text-sm text-zinc-300">
								...
								<li>
									<a
										href="https://github.com/TPAFS/transparency-data"
										class="underline hover:text-zinc-100"
									>
						...
						<div class="rounded-lg border border-zinc-800 bg-zinc-950/50 p-4">
							...
							<ol class="mt-3 space-y-2 text-sm text-zinc-300 list-decimal pl-4">
								...
								<li>
									Probe URLs live and follow redirects to verify which files
									actually respond.
								</li>
								<li>
									Rediscover missing files from hospital transparency pages when
									the seed is dead.
								</li>
								<li>
									Parse live CSV, JSON, XLSX, ZIP, and wrapper-page formats into
									one schema.
								</li>
								<li>
									Generate the on-site standardized price previews from those
									parsed files.
								</li>
							</ol>
							<p class="mt-3 text-xs text-zinc-500">
								...
								<span
									id="methodology-price-count"
									class="tab-num text-zinc-300"
								>
									{fmt(standardizedPriceHospitals)}
								</span>{" "}
								hospitals with standardized price rows, out of{" "}
								<span
									id="methodology-live-mrf-count"
									class="tab-num text-zinc-300"
								>
									{fmt(liveMrfRequired)}
								</span>{" "}
						...
						<div class="rounded-lg border border-zinc-800 bg-zinc-950/50 p-4">
							...
							<ul class="mt-3 space-y-2 text-sm text-zinc-300">
								<li>
									<strong>Compliant</strong> means a live machine-readable file
									was found and verified.
								</li>
								<li>
									<strong>Missing</strong> means no live public MRF was found
									after automated discovery and probing.
								</li>
								<li>
									<strong>Under CMS enforcement</strong> means the hospital
									appears in CMS's public enforcement record.
								</li>
								<li>
									<strong>Standardized price preview</strong> appears when
									parsed rows were actually generated for that hospital.
									Hospitals with zero generated rows are not counted in the
									headline.
								</li>
							</ul>
							<p class="mt-3 text-xs text-zinc-500">
								Current limits: some hospitals are behind bot-defense or publish
								malformed files. Missing rows can mean non-compliance, anti-bot
								blocking, or broken vendor output.
							</p>
						</div>
					</div>
				</section>
				...
				<section
					id="prices"
					class="rounded-lg border border-zinc-800 bg-zinc-900/50 p-4 sm:p-6"
				>
					<h2 class="text-2xl font-semibold tracking-tight">
						🩺 Live prices — standardized, on-site
					</h2>
					<p class="text-sm text-zinc-400 mt-1">
						Parsed directly from each hospital's MRF into a unified schema. No
						external links — search prices by CPT or HCPCS code below.
					</p>
					<div class="mt-4 grid grid-cols-1 gap-3 border-y border-zinc-800 py-4 text-sm md:grid-cols-3">
						<div>
							...
							<div
								id="price-hospital-count"
								class="mt-1 text-2xl font-semibold tab-num text-emerald-300"
							>
								{fmt(standardizedPriceHospitals)}
							</div>
						</div>
						<div>
							...
							<div
								id="price-row-count"
								class="mt-1 text-2xl font-semibold tab-num text-zinc-100"
							>
				...
				<section
					id="api"
					class="rounded-lg border border-zinc-800 bg-zinc-900 p-4 sm:p-6"
				>
					<h2 class="text-2xl font-semibold tracking-tight">Use it</h2>
					<p class="text-zinc-300 mt-2">
						Everything here is <strong>CC0 / public domain</strong>. No
						attribution required. Build whatever you want on top.
					</p>
					<div class="mt-4 grid md:grid-cols-2 gap-3 text-sm">
						<a
							href="/data/hospitals.json"
							class="rounded-md border border-zinc-700 hover:bg-zinc-800 p-3"
						>
							<div class="mono text-emerald-400">/data/hospitals.json</div>
							<div class="text-zinc-400 mt-1">
								Full dataset · 3.1 MB · {fmt(totalFacilities)} facilities
							</div>
						</a>
						<a
							href="/data/summary.json"
						...
						>
							...
							<div class="text-zinc-400 mt-1">
								Aggregate stats and count definitions
							</div>
						</a>
						<a
							href="/api/cpt-index"
						...
						>
							...
							<div class="text-zinc-400 mt-1">
								Cross-hospital CPT price index when generated
							</div>
						</a>
						<a
							href="/api/prices/100072"
							class="rounded-md border border-zinc-700 hover:bg-zinc-800 p-3"
						>
							<div class="mono text-emerald-400">/api/prices/&lt;ccn&gt;</div>
							<div class="text-zinc-400 mt-1">
								Per-hospital standardized prices via asset or R2 fallback
							</div>
						</a>
					</div>
				</section>
				...
				<footer class="border-t border-zinc-800 pt-8 text-sm text-zinc-500 space-y-2">
					<p>
						<strong>License:</strong> Data CC0 1.0 Universal · Code AGPLv3 ·
						Built from CMS Hospital General Information (public domain) +
						TPAFS/transparency-data (CC BY-SA 4.0, seed only) + live
						verification + CMS Hospital Price Transparency Enforcement
						Activities.
					</p>
					<p>
						<strong>Method:</strong> 11 stages (TPAFS seed → page parsing → Exa
						search → Claude agents → CMS-HPT marker files → email-domain
						expansion → Wayback fallback). {SITE_COUNTS.compliance_pct}% live
						MRFs found via automated probing; {fmt(standardizedPriceHospitals)}{" "}
						hospitals have standardized price rows. Updated from generated data
						on {updatedDate}.
					</p>
					<p>
						<strong>Limits:</strong> Some MRFs require browser bot-bypass
						(Akamai-walled hospitals). We don't claim 100% — and the 13.8% gap
						IS the policy artifact: federally-required, federally-cited, still
						not public.
					</p>
					<p class="text-zinc-600">
						© 2026 Hospital Ledger. Not affiliated with CMS, HHS, Cost Plus
						Drugs, or any commercial transparency vendor. No warranty.
					</p>
				</footer>
			</main>
