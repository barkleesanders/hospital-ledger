...
export async function readR2Text(bucket: R2Bucket | undefined, key: string): Promise<R2Result | null> {
...
export async function readR2Json<T>(bucket: R2Bucket | undefined, key: string): Promise<T | null> {
